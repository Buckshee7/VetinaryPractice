...
vet_3 = Vet('Tim', 'Saunders', 'static/images/dr3.jpg')
vet_4 = Vet('Brian', 'Cox')
...
treatment_1 = Treatment(animal_1, vet_1, "Vaccination: COVID First Shot", datetime.datetime(2020, 8, 14).date())
...
treatment_7 = Treatment(animal_7, vet_2, "Shell polishing", datetime.datetime(2020, 8, 14).date())
...
treatment_10 = Treatment(animal_4, vet_1, "Possible ADHD", datetime.datetime(2020, 8, 12).date())
...
treatment_13 = Treatment(animal_7, vet_1, "Vaccination: COVID First Shot", datetime.datetime(2020, 8, 14).date())
treatment_14 = Treatment(animal_8, vet_4, "Glueing on Horn", datetime.datetime(2020, 8, 13).date())
treatment_15 = Treatment(animal_9, vet_3, "Treat for 2nd degreee burns", datetime.datetime(2020, 8, 12).date())
treatment_16 = Treatment(animal_2, vet_2, "Barking up the wrong tree", datetime.datetime(2020, 8, 13).date())
...
treatment_19 = Treatment(animal_5, vet_1, "Dental work", datetime.datetime(2020, 8, 14).date())
